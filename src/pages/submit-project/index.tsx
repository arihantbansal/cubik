              ...
              <>
                ...
                <CardFooter>
                  <Button
                    ...
                    onClick={() => {
                      router.push(
                        `/${session?.user.username}+'?project=${projectId}`
                      );
                    }}
                  >
                    View Project
                ...
                >
                  ...
                  <VStack align={'start'} textAlign="start" spacing="8px">
                    ...
                    <Box
                      ...
                      color="neutral.11"
                    >
                      {getValues('category')?.map(({ category, key }: any) => (
                        <CustomTag key={key}>{category?.title}</CustomTag>
                      ))}
                    </Box>
                  </VStack>
                </Stack>
                  ...
                  {transactionError ? (
                    ...
                    <Alert status="info" variant="cubik">
                      ...
                      >
                        ...
                        Service and acknowledge that your project may be subject

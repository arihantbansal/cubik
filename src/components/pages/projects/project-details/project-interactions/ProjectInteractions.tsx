    ...
    >
      <HStack w="full" align={'start'}>
        <VStack align={'start'} gap="8px">
          <Box as="p" textStyle={'headline4'} color={'neutral11'}>
            $10.00
          </Box>{' '}
        ...
        <Center position={'absolute'} right="0" bottom="0" opacity={'0.05'}>
          <svg
            width="101"
            height="106"
            viewBox="0 0 101 106"
            ...
            <defs>
              ...
              >
                ...
                <feBlend
                  ...
                  result="effect1_dropShadow_1252_20614"
                />
                <feBlend
                  mode="normal"
                  in="SourceGraphic"
                  in2="effect1_dropShadow_1252_20614"
                  result="shape"
                />
              </filter>
            </defs>

...
const SaveIcon = React.forwardRef<HTMLOrSVGElement, React.HTMLAttributes<HTMLOrSVGElement>>(({ className, ...props }, ref) => {
    return (
        <svg {...props} className="relative w-[18px] h-[18px] overflow-hidden shrink-0" viewBox="0 0 24 24">
            <path
                stroke="currentColor"
                strokeLinecap="round"

...
const ProjectCard = React.forwardRef<HTMLDivElement, CardProps>(
    ({ className, ...props }, ref) => {
        return (
            <div {...ref} className={cn("bg-black p-3 relative w-full flex flex-col items-start justify-center text-left text-5xl text-[#fff]")}>
                <div className="self-stretch flex flex-row items-start justify-start gap-[18px]">
                    <div className="w-[82px] overflow-hidden shrink-0 flex flex-row items-center justify-between">
                        <img className="relative rounded-lg w-20 h-20 object-cover" alt="" src={props.image} />
                    </div>
                    <div className="flex-1 flex flex-col items-start justify-start gap-[8px]">
                        <div className="self-stretch flex flex-row items-end justify-start">
                            <div className="relative leading-[32px] font-semibold overflow-hidden text-xl text-ellipsis whitespace-nowrap">{props.title}</div>
                        </div>
                        <div className="self-stretch relative text-base leading-[24px] [display:-webkit-inline-box] overflow-hidden text-ellipsis [-webkit-line-clamp:2] [-webkit-box-orient:vertical]">{props.short_description}</div>
                        <div className="w-[673px] flex flex-row flex-wrap items-center justify-start py-2 px-0 box-border gap-[12px] text-[14px]">
                            <div className="flex flex-row items-center justify-start gap-[4px]">
                                <div className="h-[22px] overflow-hidden flex flex-col items-center justify-between py-px px-0 box-border">
                                    ...
                                    {props.contributor_avatars && <AvatarGroup avatars={props.contributor_avatars}/>}
                                </div>
                                {props.contributors && <div className="flex flex-row items-center justify-start gap-[3px]">
                                    <div className="relative leading-[20px] font-medium">{props.contributors}</div>
                            ...
                            <div className="flex flex-row items-center justify-start">
                                {props.matched && <div className="flex flex-row items-center justify-start gap-[3px]">
                                    <div className="relative leading-[20px] font-medium">{props.matched}</div>
                    ...
                    <div className="flex flex-col items-start justify-start py-3 px-0 text-[14px]">
                        <div className="rounded-md bg-[#00000000] box-border w-[114px] h-11 overflow-hidden shrink-0 flex flex-row items-center justify-center py-0 px-4 gap-[4px] border-[2px] border-solid border-[rgba(138, 138, 138, 0.25)]">
                            <svg className="relative w-[18px] h-[18px] overflow-hidden shrink-0" viewBox="0 0 24 24">
                                <path
                                    stroke="currentColor"
                            ...
                            <div className="flex flex-row items-center justify-center p-1">
                                <div className="relative leading-[20px] font-semibold">Save</div>
                            </div>
                        </div>
                    </div>
                </div>

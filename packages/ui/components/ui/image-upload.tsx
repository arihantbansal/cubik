...
const ImageUpload: FC = () => {
    ...
    return (
        <div {...getRootProps()} className="dark relative bg-[#333333] box-border flex w-full flex-row items-center justify-start gap-4 rounded-lg border border-dashed border-[#4d4d4d] p-4 text-left text-sm text-white">
            ...
            <div className="flex flex-1 flex-col items-start justify-start gap-1">
                {!isDragActive ? <div className="flex h-6 flex-row items-start justify-start self-stretch gap-1">
                    <div className="relative font-medium leading-5">Drop, Paste here or</div>
                ...
                </div> : <div className='relative font-medium leading-5'>Drop/Paste Image here</div>}

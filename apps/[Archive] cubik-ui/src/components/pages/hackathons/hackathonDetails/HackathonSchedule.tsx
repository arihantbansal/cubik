        ...
        {timelineValues.map(event => (
          <Step key={event.index} style={{ width: '100%' }}>
            ...
            >
              <StepStatus
                complete={
                  <Box as={BsCheckCircle} rounded="full" width="12px" height="12px" bg="#A8F0E6" />
                }
                incomplete={<Box rounded="full" width="12px" height="12px" bg="#3B3D3D" />}
            ...
            <VStack
              ...
              spacing="12px"
            >
              <Box textTransform={'capitalize'} as="p" textStyle={'title2'} color="neutral.11">
                {event.name}
              </Box>
              <HStack gap="12px">
                <HStack bg="neutral.4" rounded="12px" p="12px" spacing="8px">
                  <Box as={BiCalendar} color="white" boxSize={{ base: '16px', md: '22px' }} />

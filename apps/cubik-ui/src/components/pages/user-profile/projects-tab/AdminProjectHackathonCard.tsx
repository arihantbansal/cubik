  ...
  if (status === ProjectJoinRoundStatus.PENDING) {
    return (
      <HStack w="fit-content" rounded="full" bg="#470E47" p="6px 10px">
        <Box as={FiClock} color="#FFCCFF" boxSize={['10px', '11px', '12px', '14px']} />
        <Box
          as="p"
          noOfLines={1}
          whiteSpace={'nowrap'}
    ...
    if (startTime && isFuture(startTime)) {
      ...
      // Active in round
      return (
        <HStack w="fit-content" rounded="full" p="6px 10px" bg="surface.green.3">
          <Box as={CgMediaLive} boxSize={{ base: '14px', md: '16px' }} color="#D6FFE5" />
          <Box
            as="p"
            noOfLines={1}
            whiteSpace={'nowrap'}
      ...
      return (
        <HStack w="fit-content" rounded="full" p="6px 10px" bg="brand.teal4">
          <Box as={IoMdDoneAll} boxSize={{ base: '12px', md: '14px' }} color="#E0FFFD" />
          <Box
            as="p"
            noOfLines={1}
            whiteSpace={'nowrap'}
            ...
            <HStack justify={'space-between'} w="full">
              <HStack justify={'space-between'} w="full">
                <HStack gap={{ base: '6px', md: '8px' }}>
                  <FundingHackatonStatus status={status} endTime={endTime} startTime={startTime} />

  ...
  return (
    <HStack p="16px" rounded="12px" gap="12px" bg="#33000260">
      ...
      <Box as={"p"} textStyle={"body5"} color="white" textAlign={"start"}>
        Current {isHackathon ? "hackathon" : "Round"} has ended! Stay tuned till
        the next {isHackathon ? "hackathon" : "Round"} starts.{" "}
        <Link
    ...
    <HStack p="16px" rounded="12px" gap="12px" bg="#31F57910">
      ...
      <Box as={"p"} textStyle={"body5"} color="white" textAlign={"start"}>
        ...
        <Box as="span" display={"inline-block"}>
          {CountdownTimer({ date: endingDate })}
        </Box>{" "}
      </Box>
    </HStack>
  );
